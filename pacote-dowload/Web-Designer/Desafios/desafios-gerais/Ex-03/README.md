...
6 - Crie 5 blocos, e dentro de cada um coloque um h3 e um parágrafo e altere os tamanhos, cores (use as cores, green, red, azul), tranformação(todas as letras em maiúsculas) e decoração dos textos de acordo com a imagem de layout.png, use o arquivo styles.css que esta dentro da pasta css.
